...
func (m *Manager) createRsyslogConfig() error {
	...
	// Force high-precision ISO 8601/RFC3339 timestamp format for consistency across distributions
	// Format: "2025-10-17T07:22:12.225840+00:00" (includes year, timezone, microseconds)
	content.WriteString("# Use high-precision RFC3339/ISO 8601 timestamp format (consistent across all distros)\n")
	content.WriteString("$ActionFileDefaultTemplate RSYSLOG_FileFormat\n\n")
